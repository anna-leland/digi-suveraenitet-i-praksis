...
- text editor: zettlr - markdown dokumentation
- git gui: sourcegit - den som gør jeg kan pushe mine ændringer i zettlr op i mit repo
...
# ændringer
jeg har fået zettlr
laver lige en ny ændring efter mødet for at se om jeg stadig kan alene uden Jans hjælp